#!/usr/bin/env bash
# Captured environment: 20260623_113314
...
export EPOCHREALTIME="1782232394.294095"
...
export SPACK_LOADED_HASHES="dxjscrsy4rkvsa3nnu6xajvxh4vzrnsb"
