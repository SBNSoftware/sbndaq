#!/usr/bin/env bash
# Captured environment: 20250806_132919
...
export CMAKE_PREFIX_PATH=/daq/software/spack_packages/sbndaq-suite/v1_10_08/linux-almalinux9-x86_64_v2-gcc-13.1.0-km2satp5ha3u4q3tiifwoecju2xqw4en:\
...
export EPOCHREALTIME="1754504959.602136"

export EPOCHSECONDS="1754504959"
...
/daq/software/spack_packages/sbndaq/v1_10_08/linux-almalinux9-x86_64_v2-gcc-13.1.0-6tmoeg6zvrdutraapxwucl7pdtvkbqjb/bin:\
