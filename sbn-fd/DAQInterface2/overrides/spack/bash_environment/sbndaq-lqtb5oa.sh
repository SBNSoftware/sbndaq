#!/usr/bin/env bash
# Captured environment: 20250801_115124
...
export EPOCHREALTIME="1754067084.716475"

export EPOCHSECONDS="1754067084"
...
export SRANDOM="392144583"

export SSH_AUTH_SOCK="/tmp/ssh-XXXXqQ969v/agent.96797"
