#!/usr/bin/env bash
# Captured environment: 20250722_145249
...
export ARTDAQ_DATABASE_CA_CERT="/daq/software/database/config/sbnd-mongodb-ca.pem"

export ARTDAQ_DATABASE_CLIENT_CERT="/daq/software/database/config/sbnd-mongodb-client-rw-cert.pem"
...
export ARTDAQ_DATABASE_URI="mongodb://sbnd-db03.fnal.gov:28058,sbnd-db04.fnal.gov:28058/sbnd_db?replicaSet=rs-sbndprod"
...
export EPOCHREALTIME="1753213969.690183"

export EPOCHSECONDS="1753213969"
...
export KRB5CCNAME="FILE:/tmp/krb5cc_51307_XXXXKxVbWz"
...
export MOZ_GMP_PATH="/usr/lib64/mozilla/plugins/gmp-gmpopenh264/system-installed"
...
export OLDPWD="/home/nfs/sbnd/DAQ_SPACK_DevAreas"
