#!/usr/bin/env bash
# Captured environment: 20250909_122754
...
export EPOCHREALTIME="1757438874.061440"

export EPOCHSECONDS="1757438874"
...
export GIT_EXEC_PATH="/home/nfs/sbnd/.dotfiles/local/Linux-x86_64-k5.14.0/libexec/git-core"
...
export INSTALL_PREFIX="/home/nfs/sbnd/.dotfiles/local/Linux-x86_64-k5.14.0"
...
export TMUX="/tmp/tmux33a/tmux-51307/default,2099485,0"

export TMUX_PANE="%5"

export TMUX_PLUGIN_MANAGER_PATH="/home/nfs/sbnd/.dotfiles/config/tmux/plugins/"
...
export file="/home/nfs/sbnd/.dotfiles/local/Linux-x86_64-k5.14.0/completions/zoxide.bash"

export i="1"

export ls_bin="/usr/bin/ls"

export my_INSTALL_PREFIX="/home/nfs/sbnd/.dotfiles/local/Linux-x86_64-k5.14.0"

export need_module="no"

export new_dirs="/home/nfs/sbnd/.dotfiles/.share/flatpak/exports/share"

export nvim_bin="/home/nfs/sbnd/.dotfiles/local/Linux-x86_64-k5.14.0/bin/nvim"
...
export tmux_bin="/home/nfs/sbnd/.dotfiles/local/Linux-x86_64-k5.14.0/bin/tmux"
...
{ 
    ...
    if [[ ${#COMP_WORDS[@]} -eq 2 ]]; then
        ...
        if [[ -z ${COMP_WORDS[-1]} ]] && [[ ${COMP_WORDS[-2]} != "${__zoxide_z_prefix}"?* ]]; then
            \builtin local result;
            result="$(\command zoxide query --exclude "$(__zoxide_pwd)" --interactive -- "${COMP_WORDS[@]:1:${#COMP_WORDS[@]}-2}")" && COMPREPLY=("${__zoxide_z_prefix}${result}/");
            \builtin printf '\e[5n';
        fi;
    fi
}
