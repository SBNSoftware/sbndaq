#!/usr/bin/env bash
# Captured environment: 20250806_113901
...
export CMAKE_PREFIX_PATH=/daq/software/spack_packages/artdaq-runcontrol-gui/v1_03_06/linux-scientific7-x86_64_v2-gcc-13.1.0-ulowexu3trvejdyqpyjclr655wazegdg:\
...
export DAQ_SETUP_SCRIPT="/home/nfs/sbnd/DAQ_SPACK_ProdAreas/DAQ_2025-08-01_GAL_v1_10_08/srcs/sbndaq/sbn-nd/DAQInterface2/setup_sbn_artdaq.sh"
...
/home/nfs/sbnd/SBND_DAQ3/dev/srcs/sbnddaq_readout/bin:\
/usr/kerberos/sbin:\
/usr/kerberos/bin:\
/usr/local/sbin:\
/usr/sbin:\
...
export PHOEBUS_DIR="/home/nfs/sbnddcs/css/phoebus/phoebus-product"
...
export THIS_SBN_DAQ_DAQINTERFACE_DIR="/home/nfs/sbnd/DAQ_SPACK_ProdAreas/DAQ_2025-08-01_GAL_v1_10_08/srcs/sbndaq/sbn-nd/DAQInterface2"

export TMPPATH="/home/nfs/sbnd/.cache/abrt/lastnotification.PBllF6GF"
...
export _recursion="false"

export _rhsm_debug_common_opts="-h --help --proxy --proxyuser --proxypassword --noproxy"

export _scl_dir="/etc/scl/conf"

export _scl_prefix

export _scl_prefix_file="/etc/scl/conf/devtoolset-11"

export _scl_scriptlet_name="enable"

export _scl_source_help="Usage: source scl_source <action> [<collection> ...] Don't use this script outside of SCL scriptlets! Options: -h, --help display this help and exit"
